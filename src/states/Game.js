...
import SpriteGravity from '../helper/SpriteGravity'
...
export default class extends Phaser.State {
  ...
  create () {
    ...
    game.physics.arcade.enable([this.cell, this.cell2]);
    
    this.cell.update = () => {
      SpriteGravity.accelerateToObject(this.cell, this.cell2);
    };
  
    this.cell2.update = () => {
      SpriteGravity.accelerateToObject(this.cell2, this.cell);
    };
